...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Paciente>().HasData(
            ...
            new Paciente { Id = 2, NombreCompleto = "Mariana López", DNI = "31202456", Email = "mariana.lopez@hotmail.com", Telefono = "1167891234", NoShowCount = 2, Bloqueado = false, FechaBloqueo = null, CreatedAt = new DateTime(2026, 1, 24), IsActive = true },
            ...
            new Paciente { Id = 7, NombreCompleto = "Facundo Sosa", DNI = "27345678", Email = "facundo.sosa@outlook.com", Telefono = "1112345678", NoShowCount = 3, Bloqueado = true, FechaBloqueo = new DateTime(2026, 4, 19), CreatedAt = new DateTime(2025, 10, 27), IsActive = true },
